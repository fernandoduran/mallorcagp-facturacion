<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Presupuesto | Mallorca GP";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, presupuestos.id_vendedor, presupuestos.fecha_factura, presupuestos.condiciones, presupuestos.estado_factura, presupuestos.numero_factura";
		$sql_factura=mysqli_query($con,"select $campos from presupuestos, clientes where presupuestos.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
...
<html lang="en">
  ...
  <body>
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<label for="estado_factura" class="col-md-1 control-label">Estado</label>
								...
								<select class='form-control input-sm ' id="estado_factura" name="estado_factura">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Aceptado</option>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<textarea class='form-control input-sm' name="condiciones" id="condiciones" rows="4" cols="5">
	...
	<script type="text/javascript" src="js/editar_presupuesto.js"></script>
