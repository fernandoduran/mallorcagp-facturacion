			...
			<form class="form-horizontal" role="form" id="datos_factura">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<label for="condiciones" class="col-md-1 control-label">Observaciones </label>
							<div class="col-md-3">
								<textarea class='form-control input-sm' id="condiciones" rows="4" cols="5">
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="submit" class="btn btn-default" onclick="window.location.href='facturas.php'">
