<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('nombre_cliente', 'matricula');//Columnas de busqueda
		 $sTable = "clientes";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $matricula;?>" id="matricula<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $kilometros;?>" id="kilometros<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $marca;?>" id="marca<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $bastidor;?>" id="bastidor<?php echo $id_cliente;?>">
