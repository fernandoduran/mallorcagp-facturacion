<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Nombre vacío";
			...
			$errors[] = "Introduzca la direccion del cliente";
		}  else if (
			!empty($_POST['mod_id']) &&
		...
		$matricula=mysqli_real_escape_string($con,(strip_tags($_POST["mod_matricula"],ENT_QUOTES)));
		//$km=mysqli_real_escape_string($con,(strip_tags($_POST["mod_kilometros"],ENT_QUOTES)));
		$km=intval($_POST['mod_kilometros']);
		$marca=mysqli_real_escape_string($con,(strip_tags($_POST["mod_marca"],ENT_QUOTES)));
		$bastidor=mysqli_real_escape_string($con,(strip_tags($_POST["mod_bastidor"],ENT_QUOTES)));
		...
		$sql="UPDATE clientes SET nombre_cliente = '".$nombre."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."', dni = '".$dni."', matricula = '".$matricula."', kilometros = '".$km."', marca = '".$marca."', bastidor = '".$bastidor."' WHERE id_cliente='".$id_cliente."'";
