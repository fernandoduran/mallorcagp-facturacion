<?php
	...
	if (empty($_POST['nombre_empresa'])) {
           ...
           $errors[] = "Dirección esta vacío";
        } else if (empty($_POST['nif_cif'])) {
           $errors[] = "NIF esta vacío";
        }   else if (
		...
		$nif_cif=mysqli_real_escape_string($con,(strip_tags($_POST["nif_cif"],ENT_QUOTES)));
		
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."', telefono='".$telefono."', email='".$email."', impuesto='".$impuesto."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal', nif_cif = '$nif_cif' WHERE id_perfil='1'";
