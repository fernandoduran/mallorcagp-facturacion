<?php
	...
	if (empty($_POST['nombre'])) {
		...
		$bastidor=mysqli_real_escape_string($con,(strip_tags($_POST["bastidor"],ENT_QUOTES)));
		$estado=intval($_POST['estado']);
		$date_added=date("Y-m-d H:i:s");
		$sql="INSERT INTO clientes (nombre_cliente, telefono_cliente, email_cliente, direccion_cliente, status_cliente, date_added, dni, matricula, kilometros, marca, bastidor) VALUES ('$nombre','$telefono','$email','$direccion','$estado','$date_added', '$dni', '$matricula', '$km', '$marca', '$bastidor')";
