<?php
	...
	$sql_count=mysqli_query($con,"select * from presupuestos where id_factura='".$id_factura."'");
	...
	$sql_factura=mysqli_query($con,"select * from presupuestos where id_factura='".$id_factura."'");
