...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_presupuesto VALUES ('','$numero_factura','$id_producto','$cantidad','$precio_venta_r')");
...
?>
	 ...
	 <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt; position: relative; top: 35%;"> 
        <tr>
...
$insert=mysqli_query($con,"INSERT INTO presupuestos VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','2')");
