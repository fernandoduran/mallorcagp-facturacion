		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" id="mod_proveedor" name="mod_proveedor" placeholder="Proveedor" required maxlength="255" ></textarea>
				  
				</div>
			  </div>

			  <div class="form-group">
				<label for="mod_telf_prov" class="col-sm-3 control-label">Teléfono proveedor</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="mod_telf_prov" name="mod_telf_prov" placeholder="Telf del proveedor" required >
