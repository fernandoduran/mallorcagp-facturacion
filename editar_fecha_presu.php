  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar fecha presupuesto</h4>
		</div>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<input type="submit" class="btn btn-default" id="actu" name="actu" value="Actualizar fecha">
						 <button class="btn btn-success"><a href="presupuestos.php" style="color: white;">Volver</a></button> 

					</div>	
				</div>
			</form>
			Fecha actual del presupuesto: <?php echo $fecha_factura2;?>	
		...
		if(isset($_POST['fecha'])){
			...
			$fecha_actu = date('Y-m-d', strtotime($_POST['fecha']));
				...
				if(isset($_POST['actu'])){
					...
					$sql = "UPDATE presupuestos SET fecha_factura ='".$fecha_actu."' WHERE id_factura = '".$id_factura."'";
